...
local Window = library:AddWindow("Alosh X", {
...
local ALTab = Window:AddTab("Tools")
local ESPTab = Window:AddTab("Esp")
local RCTab = Window:AddTab("Misc")
local AnimTab = Window:AddTab("nothing)
...
folder:AddButton("Admin Guns v2", function(bool)
...
folder:AddButton("Admin Foods", function(bool)
...
CreditTAB:AddButton("Made by dv15#1000", function(bool)
    setclipboard("dv15#1000")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
CreditTAB:AddButton("Shit-Ware", function(bool)
    setclipboard("discord.gg/lowfi")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
RCTab:AddButton("Fly Glitching (X)", function(bool)
    repeat wait() 
...
ALTab:AddSwitch("AimLock Tick", function(bool)
    DaHoodSettings.AimLock = bool
end)

ALTab:AddSwitch("Webhook Function", function(bool)
    DaHoodSettings.Webh = bool
end)

ALTab:AddSwitch("Lag Function", function(bool)
    DaHoodSettings.Prediction.Lag = bool
end)

ALTab:AddSwitch("FOV", function(bool)
    Aiming.ShowFOV = bool
end)
...
ALTab:AddSwitch("Airshot Function", function(bool)
